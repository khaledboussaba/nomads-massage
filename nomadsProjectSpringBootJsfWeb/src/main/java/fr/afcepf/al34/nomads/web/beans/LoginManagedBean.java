...
//		System.out.println("VILLES : "+villeList);
	...
	@Autowired
	private CatalogueWebServiceManagedBean catalogueWebServiceManagedBean;
	...
	public String getPanierString() {
		if(estMasseur() && catalogueWebServiceManagedBean!=null) {
			
			int nbrsProduits;
			
			nbrsProduits=catalogueWebServiceManagedBean.getQteArticlePanier();
